...
public struct GpApiMapping {
    ...
    public static func mapThreeDSecure(_ doc: JsonDoc?) -> Transaction {
        ...
        secure.providerServerTransRef = doc?.get(valueFor: "three_ds")?.getValue(key: "server_trans_ref")
        secure.dsTransferReference = doc?.get(valueFor: "three_ds")?.getValue(key: "ds_trans_ref")
        ...
        secure.payerAuthenticationRequest = doc?.get(valueFor: "three_ds")?.get(valueFor: "mobile_data")?.getValue(key: "acs_signed_content")
